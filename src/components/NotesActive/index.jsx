...
export const NotesActive = ({ filteredData, deleteNote, handleArchived }) => {
  return (
    <div className="w-3/4 mx-auto mt-10">
      <h1 className="font-bold text-2xl text-center">Active Notes</h1>
      {filteredData.length === 0 ? (
        ...
        <div className="flex flex-wrap justify-center gap-3  w-full mt-5">
          {filteredData.map((item) => (
            <div
              key={item.id}
              className=" flex flex-col justify-between box-border  border-2 shadow-2xl bg-yellow-300 w-full  sm:w-1/2  lg:w-1/4  mb-2"
            >
